...
# 读取 prompt 文件
with open('./src/create_fine-tuning_dataset/prompt.txt', 'r', encoding='utf-8') as prompt_file:
...
for root, dirs, files in os.walk(folder_path):
    for filename in files:
        if filename.endswith('.txt'):
            ...
            # 将 content 写入 txt 文件
            with open("./data/fine-tuning_dataset/grape/question.txt", "w", encoding="utf-8") as file:
                file.write(content)

            print("Content has been written to question.txt")
