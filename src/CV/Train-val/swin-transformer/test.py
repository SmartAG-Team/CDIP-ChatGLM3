...
from model.CV_Model_Config.swintransformer import swin_tiny_patch4_window7_224 as create_model
...
def main():
    ...
    model_weight_path = "./model/CV_Models/trained_model_1/swin-transformer.pth"
