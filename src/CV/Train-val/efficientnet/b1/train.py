...
from model.CV_Model_Config.EfficientNet import efficientnet_b1
...
def main(args):
    ...
    for epoch in range(args.epochs):
        ...
        if val_accuracy > best_acc:
            ...
            torch.save(model.state_dict(), f"./model/CV_Models/trained_model/efficientnetb1.pth")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='./model/CV_Models/pretrain_model/efficientnetb1.pth', help='initial weights path')
