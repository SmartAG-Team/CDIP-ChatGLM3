...
# from model.cvEfficientNet import efficientnet_b0 as create_model
from tqdm import tqdm
import torch.nn as nn
current_working_directory = os.getcwd()
sys.path.append(current_working_directory)
from model.CV_Model_Config.EfficientNet import efficientnet_b2
...
def main(args):
    ...
    for epoch in range(args.epochs):
        ...
        if val_accuracy > best_acc:
            ...
            torch.save(model.state_dict(), f"./model/CV_Models/trained_model/efficientnetb2.pth")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='./model/CV_Models/pretrain_model/efficientnetb2.pth', help='initial weights path')
