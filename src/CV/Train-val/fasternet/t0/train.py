...
def main(args):
    ...
    for epoch in range(args.epochs):
        ...
        if val_accuracy > best_acc:
            ...
            torch.save(model.state_dict(), f"./model/CV_Models/trained_model/fasternett0.pth")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='./model/CV_Models/pretrain_model/fasternet_t0.pth', help='initial weights path')
