...
def main(args):
    ...
    # 打开或创建 CSV 文件
    # csv_file = open('training_results.csv', mode='w', newline='')
    ...
    for epoch in range(args.epochs):
        ...
        if val_accuracy > best_acc:
            ...
            torch.save(model.state_dict(), f"./model/CV_Models/trained_model/efficientnetv2s.pth")
        scheduler.step()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data-path', type=str,
                        default="./data/CV/CV_dataset/train-val")


    parser.add_argument('--weights', type=str, default='./model/CV_Models/pretrain_model/pre_efficientnetv2-s.pth',
