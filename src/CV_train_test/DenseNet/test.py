...
if __name__ == '__main__':
    ...
    model = densenet161(num_classes=52).to(device)
    model_weight_path = "..\densenet161.pth"
    ...
    predict_folder(folder_path, model, class_indict, device, output_folder, model_name="densenet161")