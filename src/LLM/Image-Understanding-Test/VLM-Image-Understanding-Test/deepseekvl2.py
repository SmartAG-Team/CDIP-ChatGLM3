...
parser.add_argument('--api_key', type=str, default=os.getenv('Deepseek_API_Key'), help='api key') 
parser.add_argument('--base_url',type=str,default=os.getenv('DeepseekL_API_base_url'))
parser.add_argument('--model', type=str, default='deepseek-ai/deepseek-vl2', help='model name')
...
# 结果文件路径
output_file = "./data/CV/CV_Metric/VLM-Test-Metric/DeepseekVL2.txt"
    ...
    for image_file in os.listdir(subfolder_path):
        if image_file.lower().endswith(('.png', '.jpg', '.jpeg', '.bmp', '.gif')):
            ...
            try:
                ...
                # 对处理后的图片进行 base64 编码，并构造 data URI
