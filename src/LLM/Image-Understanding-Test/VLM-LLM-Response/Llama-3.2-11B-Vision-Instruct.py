...
parser.add_argument('--model', type=str, default='llama3.2-vision:11b', help='model name')
parser.add_argument('--delay', type=int, default=0, help='api call intervals')
args = parser.parse_args()

# 输出CSV文件路径（将生成回复后的 CSV 保存到该文件）
output_file_path = './data/LLM/LLM_Metric/Specialized-Abilities-VLM-Test-Metric/VLM_Response/Llama-3.2-11B-Vision-Instruct.csv'
