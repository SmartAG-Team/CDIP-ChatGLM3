...
if __name__ == "__main__":
    ...
    # 输出CSV文件路径
    output_file_path = './data/LLM/LLM_Metric/Specialized-Abilities-Test-Metric/LLM_Response/CDIP-ChatGLM3.csv'
    ...
    generate_responses_from_csv(file_path, output_file_path)
