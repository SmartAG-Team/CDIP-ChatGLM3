...
config_path = os.path.join(current_directory, 'model', 'LLM_Config', 'Freeze','Freeze10-MTL(S2.5K+G20K).yaml')
model_path = os.path.join(current_directory, 'model', 'LLM_Models', 'ChatGLM3_6B')
output_dir = os.path.join(current_directory, 'model', 'LLM_Models', 'Freeze10-MTL(S2.5K+G20K)')
