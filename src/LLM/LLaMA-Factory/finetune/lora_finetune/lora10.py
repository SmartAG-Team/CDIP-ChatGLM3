...
config_path = os.path.join(current_directory, 'model', 'LLM_Config', 'LoRA','LoRA10.yaml')
model_path = os.path.join(current_directory, 'model', 'LLM_Models', 'ChatGLM3_6B')
output_dir = os.path.join(current_directory, 'model', 'LLM_Models', 'LoRA_before_merge', 'LoRA10')
