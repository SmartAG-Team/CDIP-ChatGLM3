...
if __name__ == "__main__":
    folder_path = "./data/LLM/LLM_dataset/13-Crop-Instruction-Following-Dataset/summary"  # 替换为你的文件夹路径
    output_file = "./data/LLM/LLM_dataset/13-Crop-Instruction-Following-Dataset/13crop.json"  # 替换为你的输出文件路径
